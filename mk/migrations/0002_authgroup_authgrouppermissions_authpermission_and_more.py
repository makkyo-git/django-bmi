...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={"db_table": "mk_user", "managed": False,},
        ),
        migrations.CreateModel(
            name="MkUserGroups",
            fields=[("id", models.BigAutoField(primary_key=True, serialize=False)),],
            options={"db_table": "mk_user_groups", "managed": False,},
        ),
        migrations.CreateModel(
            name="MkUserUserPermissions",
            fields=[("id", models.BigAutoField(primary_key=True, serialize=False)),],
            options={"db_table": "mk_user_user_permissions", "managed": False,},
        ),
        migrations.AddField(
            model_name="user",
            name="icon",
